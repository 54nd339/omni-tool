...
const ROUTE_METADATA: Record<string, RouteMeta> = {
  ...
  '/image/background-remover': { title: 'Background Remover', description: 'Remove image backgrounds with AI' },
  '/image/edit': { title: 'Image Editor', description: 'Resize, compress, and convert images' },
  '/image/aspect-ratio': { title: 'Aspect Ratio Pad', description: 'Add padding to match common aspect ratios' },
  '/image/icons': { title: 'Icon Generator', description: 'Generate icons in multiple sizes' },
  '/image/create-pdf': { title: 'Create PDF from Images', description: 'Convert images to PDF documents' },
  ...
  '/docs/split': { title: 'Split PDFs', description: 'Split and reorder PDF pages' },
  '/docs/convert': { title: 'PDF to Images', description: 'Convert PDF pages to images' },
