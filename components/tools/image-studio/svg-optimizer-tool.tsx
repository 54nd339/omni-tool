...
import { useSvgOptimizerTool } from '@/hooks/use-svg-optimizer-tool';
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <Slider
          ...
          step={1}
          value={[precision]}
          onValueChange={([value]) => setParams({ precision: String(value) })}
        />
      </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {inputPreviewUrl && (
              <div className="flex items-center justify-center rounded-md border border-border bg-[url('data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2220%22%20height%3D%2220%22%3E%3Crect%20width%3D%2210%22%20height%3D%2210%22%20fill%3D%22%23f0f0f0%22%2F%3E%3Crect%20x%3D%2210%22%20y%3D%2210%22%20width%3D%2210%22%20height%3D%2210%22%20fill%3D%22%23f0f0f0%22%2F%3E%3C%2Fsvg%3E')] p-4">
                <Image src={inputPreviewUrl} alt="Input SVG" width={800} height={400} unoptimized className="max-h-48 w-full object-contain" />
              </div>
            )}
            {outputPreviewUrl && (
              <div className="flex items-center justify-center rounded-md border border-border bg-[url('data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2220%22%20height%3D%2220%22%3E%3Crect%20width%3D%2210%22%20height%3D%2210%22%20fill%3D%22%23f0f0f0%22%2F%3E%3Crect%20x%3D%2210%22%20y%3D%2210%22%20width%3D%2210%22%20height%3D%2210%22%20fill%3D%22%23f0f0f0%22%2F%3E%3C%2Fsvg%3E')] p-4">
                <Image src={outputPreviewUrl} alt="Optimized SVG" width={800} height={400} unoptimized className="max-h-48 w-full object-contain" />
              </div>
            )}
          </div>
        </div>
