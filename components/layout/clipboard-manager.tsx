...
import {
  type ClipboardClip,
  useClipboardClearClips,
  useClipboardClips,
  useClipboardRemoveClip,
...
export function ClipboardManager() {
  const clips = useClipboardClips();
  const removeClip = useClipboardRemoveClip();
  const clearClips = useClipboardClearClips();
