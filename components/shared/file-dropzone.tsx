...
export function FileDropzone({
  ...
  return (
    <div
      ...
      className={cn(
        'flex cursor-pointer flex-col items-center justify-center gap-3 min-h-[140px] sm:min-h-[200px] p-4 sm:p-8 rounded-lg border-2 border-dashed border-border transition-colors text-center',
