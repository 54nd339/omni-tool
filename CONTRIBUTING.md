...
| PDF Suite | `/pdf/` | PDF operations (merge, split, convert) |
| Media Lab | `/media-lab/` | Audio/video processing |
| Crypto Suite | `/crypto/` | Hashing, encryption, JWT |
| Dev Utils | `/dev-utils/` | Formatters, converters, diffing, APIs |
| Generators | `/generators/` | QR codes, colors, UUIDs, passwords |
| Workspace | `/workspace/` | Multi-tool layouts, whiteboard |
